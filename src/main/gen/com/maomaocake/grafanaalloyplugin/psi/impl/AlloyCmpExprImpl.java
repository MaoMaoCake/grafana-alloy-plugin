...
public class AlloyCmpExprImpl extends ASTWrapperPsiElement implements AlloyCmpExpr {

  public AlloyCmpExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AlloyAddExpr> getAddExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AlloyAddExpr.class);
  }
