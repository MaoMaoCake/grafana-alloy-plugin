...
public class AlloyParenExprImpl extends ASTWrapperPsiElement implements AlloyParenExpr {

  public AlloyParenExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AlloyExpression getExpression() {
    return findNotNullChildByClass(AlloyExpression.class);
  }
