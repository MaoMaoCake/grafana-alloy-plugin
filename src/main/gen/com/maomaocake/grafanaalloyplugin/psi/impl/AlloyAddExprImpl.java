...
public class AlloyAddExprImpl extends ASTWrapperPsiElement implements AlloyAddExpr {

  public AlloyAddExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AlloyMulExpr> getMulExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AlloyMulExpr.class);
  }
