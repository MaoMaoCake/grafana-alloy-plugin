...
public class AlloyExpressionImpl extends ASTWrapperPsiElement implements AlloyExpression {

  public AlloyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public AlloyOrExpr getOrExpr() {
    return findNotNullChildByClass(AlloyOrExpr.class);
  }
