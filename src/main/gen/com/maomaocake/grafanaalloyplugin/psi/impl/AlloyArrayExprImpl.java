...
public class AlloyArrayExprImpl extends ASTWrapperPsiElement implements AlloyArrayExpr {

  public AlloyArrayExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AlloyExpression> getExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AlloyExpression.class);
  }
