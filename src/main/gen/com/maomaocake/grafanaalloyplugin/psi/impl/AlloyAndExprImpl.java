...
public class AlloyAndExprImpl extends ASTWrapperPsiElement implements AlloyAndExpr {

  public AlloyAndExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AlloyCmpExpr> getCmpExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AlloyCmpExpr.class);
  }
