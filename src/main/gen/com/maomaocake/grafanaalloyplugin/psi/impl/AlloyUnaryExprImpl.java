...
public class AlloyUnaryExprImpl extends ASTWrapperPsiElement implements AlloyUnaryExpr {

  public AlloyUnaryExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AlloyOperExpr getOperExpr() {
    return findChildByClass(AlloyOperExpr.class);
  }

  @Override
  @Nullable
  public AlloyUnaryExpr getUnaryExpr() {
    return findChildByClass(AlloyUnaryExpr.class);
  }
