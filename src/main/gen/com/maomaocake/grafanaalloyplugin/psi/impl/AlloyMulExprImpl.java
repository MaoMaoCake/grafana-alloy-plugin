...
public class AlloyMulExprImpl extends ASTWrapperPsiElement implements AlloyMulExpr {

  public AlloyMulExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AlloyPowExpr> getPowExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AlloyPowExpr.class);
  }
